...
<section id="main_content">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h4>Edit <?= $serv_det['service_name'] ?> Service</h4>
                <hr>
                <?= form_open() ?>
                ...
                <div class="post">
                    ...
                    <div class="form-group">
                        Service Name
                        <input type="text" name="txtTopic" class="form-control" placeholder="Type your service name" value="<?= $serv_det['service_name'] ?>" required="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="15" id="editor1" name="txtDesc" class="form-control" placeholder="Write your service description" style="height:250px;" required> <?= $serv_det['service_description'] ?> </textarea><br>
