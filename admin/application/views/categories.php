...
<section id="main_content">
    ...
    <div class="container">
        ...
        <h3>Portfolio/Works Categories</h3>
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h4>Categories</h4>
								...
								<?= form_open("pages/cat_edit/".$token.""); ?>
                            ...
                            <?php 
                                ...
                                <td>'.$s.'</td>
                                            <td>'.$cat->category_name.' </td> '
                                                        . '<td><a href="'.base_url().'pages/categories/cat_edit/'.$cat->id.'">Edit</a> </td><td> <a href="#" onclick="delete_cat('.$cat->id.')">Delete</a></td>
                                        </tr>';
                                    }
